...
class FuncionarioModel {
  ...
  final bool ativo;
  final List<String> modulosAcesso;
  ...
  factory FuncionarioModel.fromMap(Map<String, dynamic> map, [String? id]) {
    return FuncionarioModel(
      ...
      modulosAcesso: List<String>.from(map['modulos_acesso'] ?? []),
  ...
  FuncionarioModel copyWith({
    ...
    return FuncionarioModel(
      ...
      modulosAcesso: modulosAcesso ?? this.modulosAcesso,
